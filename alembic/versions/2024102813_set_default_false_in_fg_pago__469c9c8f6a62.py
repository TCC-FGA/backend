...
def upgrade() -> None:
    ...
    op.drop_column('parcelas', 'mes_referencia')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('parcelas', sa.Column('mes_referencia', postgresql.ENUM('janeiro', 'fevereiro', 'março', 'abril', 'maio', 'junho', 'julho', 'agosto', 'setembro', 'outubro', 'novembro', 'dezembro', name='mes_referencia'), autoincrement=False, nullable=False))
